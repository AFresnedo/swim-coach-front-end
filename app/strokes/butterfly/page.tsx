      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-12">
          ...
          <p className="text-lg text-zinc-500 dark:text-zinc-400 max-w-2xl leading-relaxed">
            Butterfly is the most physically demanding stroke. The key is not raw
            power but rhythm — an undulating body wave, precise kick timing, and
            a relaxed recovery make butterfly sustainable and fast. These drills
            break the stroke into manageable pieces.
          </p>
        </div>
